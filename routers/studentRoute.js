...
import {
  getAllLeaveRequestsByStudentId,
  getAllLeaveRequestsType,
  getStudingTimeByDate,
  CreateLeaveRequest,
  getLeaveRequestById,
  cancelLeaveRequest,
} from "../controllers/leaverequestController.js";
import {
  studentAttendenceEnrollment,
  saveAttendenceByLeader,
  saveAttendenceByStudentWithQR,
  isEnrollment,
...
import {
  saveActivityByStudentWithQR,
  getActivityByLeader,
  getActivity,
  paticipatedActivityByLeader,
  getActivityStudent,
  activityCheckIn,
...
router.get("/behavior/score/transaction", getBehaviorScoreTransaction);
