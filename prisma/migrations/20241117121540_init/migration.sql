...
CREATE TABLE `Student` (
    ...
    `cityzenId` VARCHAR(191) NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,

    UNIQUE INDEX `Student_email_key`(`email`),
    UNIQUE INDEX `Student_tel_key`(`tel`),
    UNIQUE INDEX `Student_cityzenId_key`(`cityzenId`),
    PRIMARY KEY (`stdId`)
...
CREATE TABLE `SubjectType` (
    ...
    UNIQUE INDEX `SubjectType_subTypeCode_key`(`subTypeCode`),
...
CREATE TABLE `Attendance` (
    ...
    `attStatus` VARCHAR(191) NOT NULL,
...
CREATE TABLE `Activity` (
    ...
    `actStatus` VARCHAR(191) NOT NULL,
    `actDesc` VARCHAR(191) NULL,
    `actLocation` VARCHAR(191) NULL,
    `actStartTime` DATETIME(3) NULL,
    `actEndTime` DATETIME(3) NULL,
